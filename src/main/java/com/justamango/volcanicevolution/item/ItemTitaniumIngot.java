...
public class ItemTitaniumIngot extends ElementsVolcanicevolutionMod.ModElement {
	@GameRegistry.ObjectHolder("volcanicevolution:titaniumingot")
	public static final Item block = null;
	public ItemTitaniumIngot(ElementsVolcanicevolutionMod instance) {
		super(instance, 25);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("volcanicevolution:titaniumingot", "inventory"));
	}
