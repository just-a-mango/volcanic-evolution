...
import com.justamango.volcanicevolution.procedure.ProcedureVolcanicHammerBlockDestroyedWithTool;
...
public class ItemVolcanicHammer extends ElementsVolcanicevolutionMod.ModElement {
	@GameRegistry.ObjectHolder("volcanicevolution:volcanichammer")
	public static final Item block = null;
	public ItemVolcanicHammer(ElementsVolcanicevolutionMod instance) {
		super(instance, 68);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
				...
				int z = (int) entity.posZ;
				{
					...
					ProcedureVolcanicHammerBlockDestroyedWithTool.executeProcedure($_dependencies);
				}
				return retval;
			}
		...
		}.setUnlocalizedName("volcanichammer").setRegistryName("volcanichammer").setCreativeTab(TabVolcanicEvolution.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("volcanicevolution:volcanichammer", "inventory"));
	}
