...
import com.justamango.volcanicevolution.item.ItemTitaniumIngot;
...
public class BlockTitaniumOre extends ElementsVolcanicevolutionMod.ModElement {
	@GameRegistry.ObjectHolder("volcanicevolution:titaniumore")
	public static final Block block = null;
	public BlockTitaniumOre(ElementsVolcanicevolutionMod instance) {
		super(instance, 23);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("volcanicevolution:titaniumore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			...
			setHardness(19.2F);
			setResistance(22.07567458337944F);
			setLightLevel(0F);
			setLightOpacity(255);
