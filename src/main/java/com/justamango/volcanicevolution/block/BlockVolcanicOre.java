...
public class BlockVolcanicOre extends ElementsVolcanicevolutionMod.ModElement {
	@GameRegistry.ObjectHolder("volcanicevolution:volcanicore")
	public static final Block block = null;
	public BlockVolcanicOre(ElementsVolcanicevolutionMod instance) {
		super(instance, 2);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("volcanicore"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("volcanicevolution:volcanicore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("volcanicore");
			setSoundType(SoundType.STONE);
			setHarvestLevel("pickaxe", 17);
			setHardness(25.200000000000003F);
			setResistance(27.440589259906922F);
			setLightLevel(0F);
			setLightOpacity(255);
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemVolcanicIngot.block, (int) (1)));
		}
	}
}
