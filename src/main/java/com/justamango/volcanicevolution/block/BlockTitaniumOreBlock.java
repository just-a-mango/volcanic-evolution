...
public class BlockTitaniumOreBlock extends ElementsVolcanicevolutionMod.ModElement {
	@GameRegistry.ObjectHolder("volcanicevolution:titaniumoreblock")
	public static final Block block = null;
	public BlockTitaniumOreBlock(ElementsVolcanicevolutionMod instance) {
		super(instance, 24);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("volcanicevolution:titaniumoreblock", "inventory"));
	}
